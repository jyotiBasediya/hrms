...
class Announcement extends MY_Controller {
	...
	public function output($Return=array()){
...

     {
		...
		$data['breadcrumbs'] = $this->lang->line('hrms_announcements');
    ...
    public function announcement_list()

     {
		...
		$announcement = $this->Announcement_model->get_announcementsByCmp();
		...
		$data = array();
          ...
          foreach($announcement as $r) {

			 			  

		// get user > added by

		$user = $this->Hrms_model->read_user_info($r->published_by);
	  ...
	  $output = array(
		   ...
		   "draw" => $draw,
			 ...
			 "recordsTotal" => count($announcement),

			 "recordsFiltered" => count($announcement),
	...
	public function add_announcement() {
		...
		if($this->input->post('title')==='') {
       		...
       		$Return['error'] = $this->lang->line('hrms_error_summary_field');
...
$session = $this->session->userdata('username');
		...
		if ($result == TRUE) {
			...
			$Return['result'] = $this->lang->line('hrms_success_add_announcement');
			...
			if($setting[0]->enable_email_notification == 'yes') {
				...
				/*foreach($this->input->post('designation_id') as $designation_id) {
					...
					$user_info = $this->Hrms_model->read_user_info_bydesignation($designation_id);				
					...
					$template = $this->Hrms_model->read_email_template(4);
	...
	public function update() {
		...
		if ($result == TRUE) {
			...
			$Return['result'] = $this->lang->line('hrms_success_update_announcement');
	...
	public function delete() {
		...
		if(isset($id)) {
			...
			$Return['result'] = $this->lang->line('hrms_success_delete_announcement');
