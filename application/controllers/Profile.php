...
class Profile extends MY_Controller {
	...
	public function documents() {
		...
		$data[] = array(
			$functions.'<span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('hrms_edit').'"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light" data-toggle="modal" data-target=".edit-modal-data" data-field_id="'. $r->document_id . '" data-field_type="document"><i class="fa fa-pencil-square-o"></i></button></span><span data-toggle="tooltip" data-placement="top" title="'.$this->lang->line('hrms_delete').'"><button type="button" class="btn btn-danger btn-sm m-b-0-0 waves-effect waves-light delete" data-toggle="modal" data-target=".delete-modal" data-record-id="'. $r->document_id . '" data-token_type="document"><i class="fa fa-trash-o"></i></button></span>',
	...
	public function shift() {
     ...
     public function my_profile()
     {
     	...
     	$data['employees_detail'] = $this->CommonModel->selectRowDataByCondition(array('user_id' => $id),'hrms_employees');
     ...
     public function update_profile()
     {
		...
		$this->session->set_flashdata('success','You profile successfully');
