...
class Timesheet extends MY_Controller {
...

	{
	   // echo 1;die;
		...
		$data['all_employee_type'] = $this->Employees_model->all_employee_type();
		$data['all_country'] = $this->Hrms_model->get_countries();
		$data['breadcrumbs'] = $this->lang->line('hrms_employees');
...
// 		$this->load->view('timesheet/timesheet_list',$data);
	...
	public function leave_request()
	{
	   ...
	   $data['leave'] = $this->Timesheet_model->applyemployee_leave($employee_id);
...
// print_r($data['leave']);die;
	...
	{
	   // $data['leave'] = $this->Timesheet_model->get_leave();
	    $data['holiday'] = $this->Timesheet_model->get_holiday();
		
		$this->load->view('common/header');
			//$data['subview'] = $this->load->view('dashboard/index',$data);
		$this->load->view('timesheet/holiday_list',$data);
    ...
    public function deleteHoliday()
    {
       ...
       $data = array(
        ...
        $data = $this->CommonModel->updateRowByCondition($condition,'hrms_holidays',$data);  
        
        if ($data) {
            $this->session->set_flashdata('success','Holiday calendar deleted successfully');
            redirect('timesheet/holiday_list');  
        }else{
            $this->session->set_flashdata('error', 'Holiday calendar not deleted');
            redirect('timesheet/holiday_list');  
        }
    }
	...
	{ 
			$id = $this->input->post('id');
         	$data = array(
                'leave_name' => $this->input->post('leave'),
                'yearly_number' => $this->input->post('yearly_number'),

             );
       // print_r($data);die();
		$this->db->where('id',$id);
		$this->db->update('hrms_leave_category',$data);	
		redirect('timesheet/leave_category');
	}

	
		public function view_leave_category()
	{
		
		$this->load->view('common/header');
			
		$this->load->view('timesheet/add_leave_category');
	...
	public function leave_category()
	{
		...
		$data['leave'] = $this->Timesheet_model->leave_category();
		
		$this->load->view('common/header');
			//$data['subview'] = $this->load->view('dashboard/index',$data);
		$this->load->view('timesheet/leave_category',$data);
	...
	public function add_leave_category()
	{
		...
		$data = array(
     	...
     	$this->db->insert('hrms_leave_category', $data);
        redirect('timesheet/leave_category');
        // $this->db->insert('hrms_leave_category', $data);
	}
	
    public function delete_leaveCategory()
    {
        $condition = array(
       ...
       $data = array(
        ...
        // print_r($condition);exit;
        $data = $this->CommonModel->updateRowByCondition($condition,'hrms_leave_category',$data);  
        
        if ($data) {
            $this->session->set_flashdata('success','Leave category deleted successfully');
            redirect('timesheet/leave_category');  
        }else{
            $this->session->set_flashdata('error', 'Leave category not deleted');
            redirect('timesheet/leave_category');  
        }
    }	
    ...
    { 
    	     ...
    	     $employee_id = $session['user_id'];
    	     $data['leave'] = $this->Timesheet_model->getemployee_leave($employee_id);
    	     
    	     $data['leave_category'] = $this->Timesheet_model->leave_category();
    	   //  print_r($data['leave_category']);die;
	     	$this->load->view('common/header');
			$this->load->view('timesheet/employee_leave',$data);
			$this->load->view('common/footer');
     ...
     public function insertleave()
     {
        ...
        //  print_r($_POST);die;
     	...
     	// print_r($data);die();
        $add_leave = $this->db->insert('hrms_leaves', $data);
    ...
    //--------------Employee Detail-------------------------------------------------------
            ...
            $dataV['type']              =   1;
            $dataV['type_msg']          =   'Apply for Leave';

            $dataV['start_date']        =   $this->input->post('sdate');
            $dataV['end_date']          =   $this->input->post('edate');
            $dataV['number_days']       =   $this->input->post('number_days');
            $dataV['note']              =   $this->input->post('note');

            $dataV['leave_name']       =   $leave_category->leave_name;
        ...
        //--------------ALl Manger send mail-----------------------------------------------------
                ...
                foreach ($getAllMangerList as $key => $value) 
                {
                    ...
                    $dataAllM['type']              =   1;
                    $dataAllM['type_msg']          =   'Apply for Leave';

                    $dataAllM['start_date']        =   $this->input->post('sdate');
                    $dataAllM['end_date']          =   $this->input->post('edate');
                    $dataAllM['number_days']       =   $this->input->post('number_days');
                    $dataAllM['note']              =   $this->input->post('note');

                    $dataAllM['leave_name']       =   $leave_category->leave_name;
        ...
        $this->session->set_flashdata('success','Leave apply Successfully.Please wait for approval');
    ...
    public function leave_balance()
    {
	    ...
	    $data['leave_balance'] = $this->Timesheet_model->getemployee_leavebalance($employee_id,$year);
	   //  print_r($data['leave_balance']);die;
	     	
     	$this->load->view('common/header');
		$this->load->view('timesheet/leave_balance',$data);
		$this->load->view('common/footer');
    }
     
    public function hr_leave_balance()
    {
	    ...
	    $data['leave_balance'] = $this->Timesheet_model->hr_leave_balance($employee_id);
	     	
     	$this->load->view('common/header');
		$this->load->view('timesheet/hr_leave_balance',$data);
		$this->load->view('common/footer');
    }
    ...
    public function filter()
    {
    	...
    	$key = $this->Timesheet_model->hr_leave_balance($employee_id);
    // 	print_r($key);die;
	...
	{ 
       ...
       // print_r($data);die();
		...
		$this->db->update('hrms_employee_leave',$data);	
		redirect('timesheet/leave_request');
	}

      public function leave_type_insert()
     {
     	$data = array(
                'leave_name' => $this->input->post('leave'),
                'yearly_number' => $this->input->post('yearly_number'),
	 ...
	 public function timesheet_list()
     {
        ...
        $data['attendances'] = $this->CommonModel->get_attendance($project_id,$task_id,$start,$end,$employee_id);
	    $data['employees'] = $this->Project_model->getAllemp();
     ...
     public function time_status()
     {
        ...
        if($status == 1)
        {
            ...
            $updateData = $this->CommonModel->updateRowByCondition($condition,'hrms_manumally_attendrance',$data);
        ...
        if($updateData){
        	 redirect('Timesheet/timesheet_list'); 
        }
     }
    public function timesheet_view()
	{
	   $session = $this->session->userdata('username');
        ...
        $data['project'] = $this->CommonModel->getEmployeeProject($employee_id);
		...
		$this->load->view('timesheet/timesheet_view',$data);

		$this->load->view('common/footer');
	}

	public function timesheet_list_filter()
	{
	   
	   $session = $this->session->userdata('username');
            
        $employee_id = $this->input->post('employees_id');
    	...
    	$key = $this->CommonModel->get_attendance($project_id,$task_id,$start,$end,$employee_id);
	...
	public function timesheet_view_filter()
	{
	...
	public function manually_attendance()
	{
	   $session = $this->session->userdata('username');
		...
		$this->load->view('timesheet/manually_attendance',$data);

		$this->load->view('common/footer');
	}
	public function insertmanually_attendance()
	{
		// print_r($_POST);die;
		...
		foreach ($start_time as $key => $value) 
		{
			...
			$insert =	$this->db->insert('hrms_manumally_attendrance', $data);
		}

		redirect('timesheet/timesheet_view');
...
// print_r($today);die;
         ...
         $data['day_task'] = $this->CommonModel->daywise($user_id,$today);
         // print_r($data['day_task']);die;

		$this->load->view('common/header');
			
		$this->load->view('timesheet/day_view',$data);
...
// print_r($today);die;
         ...
         $data['day_task'] = $this->CommonModel->weeklywise($user_id,$today);

         // print_r($data['day_task']);die;

		$this->load->view('common/header');
			
		$this->load->view('timesheet/weekly_view',$data);
...
$this->load->view('common/header');
		$this->load->view('timesheet/edit_leave',$data);
...

     {
		...
		$data['leave_detail'] = $this->Timesheet_model->edit_leave_category($id);
			$this->load->view('common/header');
// print_r($data['employees_detail']);die;
		$this->load->view('timesheet/editleavecategory',$data);
...
$session = $this->session->userdata('username');
	...
	public function import_attendance() {
	 ...
	 public function holidays() 
	 {
	   ...
	   //  	$data['holidays'] = $this->Timehseet_model->get_holiday();
	      $this->load->view("common/header");
	 ...
	 public function leave() 
	 {
	     ...
	     $data['leave'] = $this->Timesheet_model->getemployee_leave($employee_id);
	     	...
	     	$this->load->view('common/header');
			$this->load->view('timesheet/employee_leave_list',$data);
			$this->load->view('common/footer');
     }
	...
	public function status_holiday()
	{
		$data = $this->CommonModel->selectRowDataByCondition(array('holiday_id' =>  $this->input->post('holiday_id')),'hrms_holidays');
        ...
        $updateData = $this->CommonModel->updateRowByCondition($condition,'hrms_holidays',$data);  
	...
	public function edit_holiday_list($id) {
	   // $data['employees'] = $this->Project_model->getAllemp();

		$data['location'] = $this->Location_model->get_all_location();
	   	$data['holiday_detail'] = $this->Timesheet_model->edit_holiday($id);
		$this->load->view('common/header');
			
		$this->load->view('timesheet/edit_holiday',$data);
    ...
    //   print_r($data);die();
		...
		$this->db->update('hrms_holidays',$data);	
		redirect('timesheet/holiday_list');
...
$session = $this->session->userdata('username');
	...
	public function approve($id)
    {
        ...
        $update =$this->Timesheet_model->updateemployleave($data,$id);

        if($update)
        {
            //--------------Employee Detail-------------------------------------------------------
            $empLeaveDetail = $this->CommonModel->getsingle('hrms_leaves',array('id'=>$id));

            $last_id= $empLeaveDetail->emp_name;
            $employe_detail = $this->Employees_model->edit_id($last_id);


            $where = array('expense_category_id'=>$empLeaveDetail->leave);
            ...
            $dataV['password']         =   $employe_detail->password;
            $dataV['type']             =   5;
            $dataV['type_msg']         =   'Approved Leave';

            $dataV['status']           =   'approved';


            $dataV['start_date']        =   $empLeaveDetail->sdate;
            $dataV['end_date']          =   $empLeaveDetail->edate;
            $dataV['number_days']       =   $empLeaveDetail->number_days;
            $dataV['note']              =   $empLeaveDetail->note;
        ...
        // return    $this->load->view('email_templates/employee_message',$dataV);
            ...
            if($sent)
            {
                ...
                foreach ($getAllMangerList as $key => $value) 
                {
                    ...
                    $dataAllM['password']         =   $employe_detail->password;
                    $dataAllM['type']             =   5;
                    $dataAllM['type_msg']         =   'Approved Leave';

                    $dataAllM['status']           =   'approved';

                    $dataAllM['start_date']        =   $empLeaveDetail->sdate;
                    $dataAllM['end_date']          =   $empLeaveDetail->edate;
                    $dataAllM['number_days']       =   $empLeaveDetail->number_days;
                    $dataAllM['note']              =   $empLeaveDetail->note;
                    ...
                    $dataAllM['name']         =   $manger_detail->first_name.' '.$manger_detail->last_name;
        ...
        // return    $this->load->view('email_templates/employee_message',$dataV);
            ...
            if($sent)
            {
                ...
                foreach ($getAllMangerList as $key => $value) 
                {
                    ...
                    $dataAllM['password']         =   $employe_detail->password;
                    $dataAllM['type']             =   6;
                    $dataAllM['type_msg']         =   'Rejected Leave';
