    ...
    public function resignation_list()
     {
		...
		// get notice date
		$notice_date = $this->Hrms_model->set_date_format($r->notice_date);
		// get resignation date
		$resignation_date = $this->Hrms_model->set_date_format($r->resignation_date);
	...
	public function add_resignation() {
		...
		if ($result == TRUE) {
			...
			if($setting[0]->enable_email_notification == 'yes') {
				...
				//get email template
				$template = $this->Hrms_model->read_email_template(12);
				//get employee info
