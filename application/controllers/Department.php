...
class Department extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$session = $this->session->userdata('username');
		$data['breadcrumbs'] = $this->lang->line('hrms_departments');
    ...
    public function department_list()
     {
		...
		$department = $this->Department_model->get_departmentsByCmy();
		...
		$data = array();
          ...
          foreach($department as $r) {
			  ...
			  // get location
			  $location = $this->Hrms_model->read_location_info($r->location_id);
			  // get user > head
			  $head_user = $this->Hrms_model->read_user_info($r->employee_id);
			  // user full name
...
// 		} 
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_add_department');
		} else {
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_update_department');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		...
		if(isset($id)) {
			$Return['result'] = $this->lang->line('hrms_success_delete_department');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
