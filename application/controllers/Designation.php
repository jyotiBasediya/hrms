...
class Designation extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		$data['breadcrumbs'] = $this->lang->line('hrms_designations');
    ...
    public function designation_list()
     {
		...
		$designation = $this->Designation_model->get_designationsByCmy();
		...
		$data = array();
          ...
          $output = array(
               "draw" => $draw,
                 "recordsTotal" => count($designation),
                 "recordsFiltered" => count($designation),
                 "data" => $data
            );
	...
	public function add_designation() {
		...
		if($result) {
			$Return['result'] = $this->lang->line('hrms_success_add_designation');
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_update_designation');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		...
		if(isset($id)) {
			$Return['result'] = $this->lang->line('hrms_success_delete_designation');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
