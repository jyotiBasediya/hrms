...
class Policy extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
     	...
     	$data['policytotal'] = $this->Policy_model->all_policies_byCmpId($session['companyId']);
		$data['title'] = $this->Hrms_model->site_title();
		$data['all_companies'] = $this->Hrms_model->get_companies();
		$data['breadcrumbs'] = $this->lang->line('hrms_policies');
    ...
    public function policy_list()
     {
		...
		$policy = $this->Policy_model->all_policies_byCmpId($session['companyId']);
	  ...
	  $output = array(
		   "draw" => $draw,
			 "recordsTotal" => count($policy),
			 "recordsFiltered" => count($policy),
			 "data" => $data
		);
	...
	public function add_policy() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_add_policy');
		} else {
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_update_policy');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		...
		if(isset($id)) {
			$Return['result'] = $this->lang->line('hrms_success_delete_policy');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
