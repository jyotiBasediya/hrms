...
class Location extends MY_Controller {
	...
	public function add_location() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_add_location');
		} else {
	...
	public function update() {
		...
		if ($result == TRUE) {
			$Return['result'] = $this->lang->line('hrms_success_update_location');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
	...
	public function delete() {
		...
		if(isset($id)) {
			$Return['result'] = $this->lang->line('hrms_success_delete_location');
		} else {
			$Return['error'] = $this->lang->line('hrms_error_msg');
		}
		$this->output($Return);
