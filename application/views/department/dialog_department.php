...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('hrms_department_edit');?></h4>
</div>
<form class="m-b-1" action="<?php echo site_url("department/update").'/'.$department_id; ?>" method="post" name="edit_department" id="edit_department">
  ...
  <div class="modal-body">
      <div class="form-group">
        <label for="department-name" class="form-control-label"><?php echo $this->lang->line('hrms_name');?>:</label>
