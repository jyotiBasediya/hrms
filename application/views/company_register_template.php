         ...
         <tr bgcolor="" style="padding:0 15px;">
            <td align="center" bgcolor="#fff" style="padding:0;  background-color:#282B32; background-repeat:no-repeat; background-size:cover;" cellpadding="0" cellspacing="0">
               <table style="font-family: sans-serif;  " width="100%">
                  <tr>
                     <td style=""><img src="logo.png" alt="" style="display: block;margin: 8px auto;width: 180px; padding:10px 0 150px;">
                     </td>
                  </tr>
               </table>
            </td>
                           ...
                           <tr bgcolor="#fff" style="">
                              <td style="padding:30px  20px 30px;">
                                 <table style="font-family: sans-serif;" width="100%">
                                    <tr>
                                       <td width="100%">
                                          <p style="font-size:16px;margin:4px 0;margin: 0 0;">Hello, <strong style="font-size:20px;color:#0d7bf5;"><?=$name?></strong></p>
                                          </h4>
                                          <div style="padding-top:20px;">
                                             <div style="font-size:14px;">
                                                <p><?=$message?></p>
                                               <!--  <p>Forget Password </p> -->
                                               <!--  <a href="" style="background-color:#0d7bf5; color:#fff; padding:10px; width:100px; display:inline-block; text-align:center; text-decoration:none; border-radius:3px;">Click here</a> -->
                                             </div>
                                          </div>
                                       </td>
                                    </tr> 
                        ...
                        <table bgcolor="#fff" style="font-family: sans-serif;margin-bottom: 20px; background-color:#fff;" width="100%;" cellpadding="0" cellspacing="0">
                                 ...
                                 <div style="padding-bottom:10px;">
                                    <div style="margin:15px 0 0;">
                                       ...
                                       <h5 style="margin:0;color:#505050;font-size:16px; font-weight:normal;">
                                          <a href="#" style="color:#333;">iLinkHR Team</a>
                                       </h5>
                                    </div>
                                 </div>
                              </td>
                           ...
                           <tr>
                              <td style="color:#333 background-color:#fff; "">
                                 <p style="margin:0;font-size:12px;padding:11px 0 3px;text-align:left;">© Copyright 2017 ems Pty Ltd. All Rights Reserved.</p>
                              </td>
                           </tr>
                           </td>
                           </tr>
