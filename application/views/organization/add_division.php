                ...
                <div class="page-header">
                   <div class="d-flex justify-content-between w-100">
                    ...
                    <div class="d-flex float-right"> 
                      <a href="<?php echo site_url();?>OrganizationController/division">
                ...
                <div class="row">  
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                       <div class="col-lg-12">
                          <form action="<?php echo site_url();?>OrganizationController/add_division" method="post" data-parsley-validate enctype= "multipart/form-data">
                              <div class="">
                               <!--   <h4 class="mb-4 font-weight-semibold">Basic Information</h4> -->  
                                 <div class="form-group">
                                    <p>Name</p>
                                    <input class="form-control" type="text" name="name" data-parsley-required-message="Please enter Name" required data-parsley-group="block1" >
                                 </div> 
