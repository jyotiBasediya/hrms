                          ...
                          <form action="<?php echo site_url('add_client/register');?>" method="post" data-parsley-validate enctype= "multipart/form-data">
                              <div class="">
                               <!--   <h4 class="mb-4 font-weight-semibold">Basic Information</h4> -->  
                                 ...
                                 <div class="form-group">
                                    <p>Contact Number</p>
                                    <input class="form-control" type="Number" name="cnumber" data-parsley-required-message="Please enter Contact Number" required="">
                                 </div>
                                 <div class="form-group">
                                    <p>Contact Mail-Id</p>
                                    <input class="form-control" type="text" name="email" data-parsley-required-message="Please enter Contact Mail-Id" required="">
                                 </div> 
                               <!--   <div class="form-group">
                                    <p>Status:</p>
                                 ...
                                 <!--     <button class="btn btn-warning2 t mt-4 px-5 " type="submit" name="userSubmit">Save</button>-->
                                 <!-- </div> -->
                                  <div class="text-center">
