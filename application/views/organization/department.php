           ...
           <div class="content-wrapper">   
                <div class="page-header">
                   <div class="d-flex justify-content-between w-100">
                    ...
                    <h3 class="page-title">Role & Access </h3>
                    <div class="d-flex float-right"> 
                      <?php if(in_array('41',$role_resources_ids)) { ?>
                        <a href="<?php echo site_url();?>OrganizationController/add_department">
                        <button class="btn btn-secondary btn-fw"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add Role & Access </button>
                      </a>
                    <?php } ?>
                      <!--  -->
                    </div>  
                    ...
                    <?php
                        ...
                        <tr>
                         <td><?php echo $i++;?></td>
                          ...
                          <?php if(in_array('42',$role_resources_ids)) { ?>
                          <td> <a href="<?php echo site_url('OrganizationController/edit_department/'. $row->role_id);?>"><i class="fa fa-pencil" aria-hidden="true"></i>
                           </a></td>
                         <?php } ?>
                        </tr>
                         <?php
