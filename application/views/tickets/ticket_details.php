...
<div class="row m-b-1">
  <div class="col-md-4">
    <div class="box box-block bg-white">
      ...
      <?php
        if($ticket_priority==1): $priority = 'Low'; elseif($ticket_priority==2): $priority = 'Medium'; elseif($ticket_priority==3): $priority = 'High'; elseif($ticket_priority==4): $priority = 'Critical';elseif($ticket_priority==''): $priority = 'NA';  endif;
        ?>
