...
<html lang="en">
   ...
   <body>
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
         <ul class="nav">
            ...
            <?php if(in_array('6',$role_resources_ids) || in_array('9',$role_resources_ids) || in_array('12',$role_resources_ids) || in_array('15',$role_resources_ids)) { ?>
            <li class="nav-item">
   ...
   <?php if(in_array('17',$role_resources_ids) || in_array('20',$role_resources_ids) || in_array('25',$role_resources_ids) || in_array('23',$role_resources_ids) || in_array('57',$role_resources_ids) || in_array('60',$role_resources_ids) || in_array('27',$role_resources_ids) || in_array('32',$role_resources_ids)  || in_array('30',$role_resources_ids) || in_array('19',$role_resources_ids) || in_array('20',$role_resources_ids)) { ?>
            <li class="<?php echo $admin_class;?>">
               ...
               <ul class="nav flex-column sub-menu">
                  ...
                  <?php } if(in_array('20',$role_resources_ids)) { ?>
                      <li class="nav-item">
                         ...
                         <i class="menu-icon typcn typcn-shopping-bag"></i>
                         <span class="menu-title">Leave Category Balance</span>
                         </a>
                      </li>
              <?php } if(in_array('64',$role_resources_ids)) { ?>
                  <li class="nav-item">
                     ...
                     <i class="menu-icon typcn typcn-shopping-bag"></i>
                     <span class="menu-title">Approval Leave</span>
                     </a>
                  </li>
              ...
              <?php } if(in_array('57',$role_resources_ids)) { ?>
                ...
                <li class="nav-item">
                   ...
                   <i class="menu-icon typcn typcn-th-large-outline"></i>
                   <span class="menu-title">Approve Expense</span>
                   </a>
                </li>
            ...
            <?php }} ?>
              ...
              <?php if(in_array('35',$role_resources_ids) || in_array('38',$role_resources_ids) || in_array('41',$role_resources_ids)) { ?>
                 <li class="nav-item">
            ...
            <?php if($user_info[0]->user_role_id != '3') {?>
             <?php if(in_array('44',$role_resources_ids) || in_array('46',$role_resources_ids) || in_array('48',$role_resources_ids) || in_array('51',$role_resources_ids) || in_array('53',$role_resources_ids) || in_array('63',$role_resources_ids)) { ?>
                <li class="nav-item">
