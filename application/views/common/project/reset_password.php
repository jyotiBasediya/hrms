                        ...
                        <div class="main-div">
                            <h1>Reset Password</h1>
                              <!-- <form class="mb-1" method="post" name="hrm-form" id="hrm-form" data-redirect="dashboard?module=dashboard" data-form-table="login" data-is-redirect="1"> -->
                                ...
                                <form action="<?=base_url();?>ForgotController/verify_resetpassword?user_id=<?=$id?>" data-parsley-validate method="post" data-parsley-validate>
                                     <!-- <form class="mb-1" method="post" name="hrm-form" id="hrm-form" action="<?php echo site_url('login/login')?>"> -->

                              

                                <div class="form-group">
                                  <input type="Password" placeholder="New Password" name="npwd" class="form-control p_input" id="npwd" placeholder="New Password" data-parsley-required data-parsley-required-message="Please Enter New Password">
                                </div>

                                 <div class="form-group">
                                  <input type="Password" placeholder="Confirm New Password"  name="cpwd" class="form-control p_input" id="cpwd" placeholder="Confirm Password" data-parsley-required data-parsley-required-message="Please Enter Confirm New Password" data-parsley-equalto="#npwd" data-parsley-equalto-message="Password and Confirm password must be same" >
                                </div>

                                
                                
                                <div class="form-group">
                        <button type="submit" class="btn btn-primary btn-gradient3 ">Reset Password</button>
                    </div>
