...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('hrms_designation_edit');?></h4>
</div>
     ...
     <div class="row">
      <div class="col-md-6">
        <div class="form-group">
          <h6><?php echo $this->lang->line('hrms_department');?></h6>
          <select name="department_id" id="select2-demo-6" class="form-control" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_select_department');?>...">
            <option value=""></option>
      ...
      <div class="col-md-6">
        <h6><?php echo $this->lang->line('hrms_designation');?></h6>
