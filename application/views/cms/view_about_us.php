              ...
              <div class="col-lg-12">
                ...
                <form class="form-horizontal" action="<?php echo site_url();?>CmsController/update_cms" enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" required="" id="" class="form-control" name="title" value="<?= $getfaqDetail->title;?>" placeholder="Enter Title" readonly="">
                  ...
                  <div class="form-group">
                   ...
                   <p>Content</p>
                    ...
                    <textarea id="editor1" rows="10" cols="100" class="ckeditor" name="description" required data-parsley-required data-parsley-required-message="Enter Description" readonly=""><?php if (!empty($getfaqDetail->description)) { echo $getfaqDetail->description; } ?></textarea>
