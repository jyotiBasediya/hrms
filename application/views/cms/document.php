              ...
              <div class="col-lg-12">
                ...
                <form class="form-horizontal" action="<?php echo site_url();?>CmsController/update_cms" enctype="multipart/form-data" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <textarea id="editor1" row ="500" size="100" class="ckeditor" name="description" required data-parsley-required data-parsley-required-message="Enter Description"><?php if (!empty($data->description)) { echo $data->description; } ?></textarea>
