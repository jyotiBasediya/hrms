                ...
                <form class="form-horizontal" action="<?php echo site_url('CmsController/edit_news');?>" enctype="multipart/form-data" method="post" data-parsley-validate="">
                  ...
                  <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                     ...
                     <textarea required="" id="title" class="form-control ckeditor" name="title" required data-parsley-required data-parsley-required-message="Enter title"><?= $getNewDetail->title;?></textarea>

                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">Description</label>
                    
                     <textarea required="" id="description" class="form-control ckeditor" name="description" required data-parsley-required data-parsley-required-message="Enter Answer " ><?= $getNewDetail->description;?></textarea>
