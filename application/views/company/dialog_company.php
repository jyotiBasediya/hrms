...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-pencil7"></i> <?php echo $this->lang->line('hrms_edit_company');?></h4>
</div>
    ...
    <div class="row">
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_company_name');?>" name="name" type="text" value="<?php echo $name;?>">
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="email"><?php echo $this->lang->line('hrms_company_type');?></label>
              <select class="form-control" name="company_type" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_company_type');?>">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_company_trading');?>" name="trading_name" type="text" value="<?php echo $trading_name;?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_company_registration');?>" name="registration_no" type="text" value="<?php echo $registration_no;?>">
            </div>
            <div class="col-md-6">
              <label for="contact_number"><?php echo $this->lang->line('hrms_contact_number');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_contact_number');?>" name="contact_number" type="number" value="<?php echo $contact_number;?>">
            </div>
          </div>
        </div>
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_website_url');?>" name="website" value="<?php echo $website_url;?>" type="text">
            </div>
          </div>
        </div>
        <div class="form-group">
      ...
      <div class="col-sm-6">
        <div class="form-group">
          ...
          <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_gtax');?>" name="hrms_gtax" value="<?php echo $government_tax;?>" type="text">
        </div>
        <div class="form-group">
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><i class="icon-eye4"></i> <?php echo $this->lang->line('hrms_view_company');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="hrms_company_type"><?php echo $this->lang->line('hrms_company_type');?></label>
        ...
        <div class="form-group">
          <div class="row">
            ...
            <div class="col-md-6">
              <label for="registration_no"><?php echo $this->lang->line('hrms_contact_number');?></label>
        ...
        <div class="form-group">
          <h6>
            <label><?php echo $this->lang->line('hrms_company_logo');?></label>
          </h6>
          <?php if($logo!='' || $logo!='no-file'){?>
