...
<div class="row m-b-1">
  <div class="col-md-3">
    <div class="box bg-white">
      <ul class="nav nav-4">
        ...
        <li class="nav-item nav-item-link" id="config_20"> <a class="nav-link nav-tabs-link" href="#benefits_type" data-config="20" data-config-block="benefits_type" data-toggle="tab" aria-expanded="true"> <i class="fa fa-money"></i> Benefits Type </a> </li>
      </ul>
    </div>
  </div>
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_contract_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Contract Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_document_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Document Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_education_level" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_qualification_language" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Language</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_qualification_skill" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Skill</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_payment_method" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_award_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Award Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_leave_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Leave Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_warning_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Warning Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_termination_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_expense_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Expense Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_job_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Job Type</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_exit_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_travel_arr_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
      ...
      <div class="row">
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            ...
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_currency_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Name</th>
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="benefits_type" style="display:none;">
    <div  class="box box-block bg-white">
      <div class="row">
        <div class="col-md-5">
          <div class="box box-block bg-white">
            <h2><strong>Add New</strong> Benefits Type</h2>
            <form class="m-b-1 add" id="benefits_type_info" action="<?php echo site_url("settings/benefits_type_info") ?>" name="benefits_type_info" method="post">
              <div class="form-group">
                <label for="benefit_type">Benefits Type</label>
                <input type="text" class="form-control" name="benefit_type" placeholder="Enter Benefits Name">
              </div>
              <button type="submit" class="btn btn-primary save">Save</button>
            </form>
          </div>
        ...
        <div class="col-md-7">
          <div class="box box-block bg-white">
            <h2><strong>List All</strong> Benefits</h2>
            <div class="table-responsive" data-pattern="priority-columns">
              <table class="table table-striped table-bordered dataTable" id="hrms_table_benefit_type" style="width:100%;">
                <thead>
                  <tr>
                    <th>Action</th>
                    <th>Name</th>
