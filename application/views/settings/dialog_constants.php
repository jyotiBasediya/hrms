...
$row = $this->Hrms_model->read_document_type($_GET['field_id']);
?>
...
$(document).ready(function(){
	...
	var hrms_table_document_type = $('#hrms_table_document_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					hrms_table_document_type.api().ajax.reload(function(){ 
...
$row = $this->Hrms_model->read_contract_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_contract_type = $('#hrms_table_contract_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_contract_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_payment_method($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_payment_method = $('#hrms_table_payment_method').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_payment_method.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_education_level($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_education_level = $('#hrms_table_education_level').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_education_level.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_qualification_language($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_qualification_language = $('#hrms_table_qualification_language').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_qualification_language.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_qualification_skill($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_qualification_skill = $('#hrms_table_qualification_skill').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_qualification_skill.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_award_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_award_type = $('#hrms_table_award_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_award_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_leave_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_leave_type = $('#hrms_table_leave_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_leave_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_warning_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_warning_type = $('#hrms_table_warning_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_warning_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_termination_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_termination_type = $('#hrms_table_termination_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_termination_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_expense_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_expense_type = $('#hrms_table_expense_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_expense_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_job_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_job_type = $('#hrms_table_job_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_job_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_exit_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_exit_type = $('#hrms_table_exit_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_exit_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_travel_arr_type($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_travel_arr_type = $('#hrms_table_travel_arr_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_travel_arr_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
$row = $this->Hrms_model->read_currency_types($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_currency_type = $('#hrms_table_currency_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		...
		$.ajax({
			...
			success: function (JSON) {
				if (JSON.error != '') {
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_currency_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
...
<div class="modal-header">
  ...
  <div class="modal-body">
      <div class="form-group">
        ...
        <?php foreach($this->Hrms_model->all_policies() as $_policy):?>
                    ...
                    <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $_policy->policy_id;?>" aria-expanded="true" aria-controls="collapseOne">
						 ...
						 if($_policy->company_id==0){
							...
							$company = $this->Hrms_model->read_company_info($_policy->company_id);
...
<?php } else if(isset($_GET['jd']) && isset($_GET['field_id']) && $_GET['data']=='ed_benefit_type' && $_GET['type']=='ed_benefit_type'){
$row = $this->Hrms_model->read_benefit_types($_GET['field_id']);
?>
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data">Edit Benefit Type</h4>
</div>
<form class="m-b-1" action="<?php echo site_url("settings/update_benefit_type") ?>/<?php echo $row[0]->benefit_type_id;?>/" method="post" name="ed_benefit_type_info" id="ed_benefit_type_info">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $row[0]->benefit_type_id;?>">
  <input type="hidden" name="ext_name" value="<?php echo $row[0]->benefit_type;?>">
  <div class="modal-body">
      <div class="form-group">
        <label for="benefit_type">Benefit Name</label>
        <input type="text" class="form-control" name="benefit_type" placeholder="Enter Benefit Name" value="<?php echo $row[0]->benefit_type;?>">
      </div>
    </div>
  <div class="modal-footer">
    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
$(document).ready(function(){
	// On page load: datatable
	var hrms_table_benefits_type = $('#hrms_table_benefit_type').dataTable({
		"bDestroy": true,
		"bFilter": false,
		"iDisplayLength": 5,
		"aLengthMenu": [[5, 10, 30, 50, 100, -1], [5, 10, 30, 50, 100, "All"]],
		"ajax": {
            url : "<?php echo site_url("settings/benefits_type_list") ?>",
            type : 'GET'
        },
		"fnDrawCallback": function(settings){
		$('[data-toggle="tooltip"]').tooltip();          
	...
	/* Edit data */
	$("#ed_benefit_type_info").submit(function(e){
	/*Form Submit*/
	e.preventDefault();
		var obj = $(this), action = obj.attr('name');
		$('.save').prop('disabled', true);
		$.ajax({
			type: "POST",
			url: e.target.action,
			data: obj.serialize()+"&is_ajax=46&type=edit_record&data=ed_benefit_type_info&form="+action,
			cache: false,
			success: function (JSON) {
				if (JSON.error != '') {
					toastr.error(JSON.error);
					...
					$('.edit_setting_datail').modal('toggle');
					hrms_table_benefits_type.api().ajax.reload(function(){ 
						toastr.success(JSON.result);
					}, true);
					$('.save').prop('disabled', false);				
				}
