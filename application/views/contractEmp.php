	...
	<div class="privacyPage">
		<div class="container">
			<div class="privacyContent">
				<div class="clearfix">
					<h3 class="pull-left"><?=$getContractData->title?></h3>
					<p class="pull-right from-date"><?php echo 'From '.$getContractData->from_date.' To '.$getContractData->to_date; ?></p>
				</div>

				<p><?=$getContractData->description?></p>
			</div>
		</div>
	</div>
