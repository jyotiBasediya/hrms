                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                       <div class="col-lg-12">
                          ...
                          <form action="<?php echo base_url('employees/updates');?>" method="post" name="add_employee" data-parsley-validate enctype="multipart/form-data">
                              <div class="">
                             ...
                             <div class="form-group">
                                    <p>Level</p>
                                     <select class="form-control" name="level" required data-parsley-required-message="Select level">
                                 ...
                                 <div class="form-group">
                                    <p>Start Date</p>
                                     <input type="date" onchange="fromDate(this.value);" id="sdate" name="sdate" class="form-control" required data-parsley-required-message="Please select start date" value="<?php echo $employees_detail->date_of_joining?>" >
                                 </div>

                                  <?php if($employees_detail->empType=='contractor') {?>
                                     <div class="form-group end_date_div">
                                        <p>End Date</p>
                                        <input type="date" name="edate" id="edate" class="form-control" value="<?php echo $employees_detail->date_of_leaving?>">
                                     </div> 
                                  <?php } else {?>
                                 ...
                                 <div class="form-group">
                                    <p>Role</p>
                                     ...
                                     <option  value="">Select Role</option>
                                        <?php foreach($all_roles as $value) {?>
                                            <option  value="<?php echo  $value->role_id?>" <?php if( $value->role_id==$employees_detail->division){ echo 'selected'; } ?>><?php echo  $value->role_name?></option>
                                         <?php } ?>
                                    </select>
                                 </div> 
                                 ...
                                 <div class="form-group">
                                    <p>Default Task:</p>
                                    <input class="form-control" type="text" name="task" value="<?php echo $employees_detail->default_task?>">
                                 </div> 
                                 <div class="form-group">
                                    <p>Employee Number</p>
                                    <input class="form-control" type="text" name="enumuber"  value="<?php echo $employees_detail->employee_id?>">
                                 </div> 
                                 <div class="form-group">
                                    <p>Accounting Package Person ID</p>
                                    <input class="form-control" type="text" name="account" value="<?php echo $employees_detail->accounting_id?>">
                                 </div> 
                                 <div class="form-group">
                                    <p>Status:</p>
                              ...
                              <div class="mt-5">
                                  ...
                                  <div class="form-group">
                                    <p class="mt-2"><input class="mr-2" type="checkbox" id ="timesheat_check" name="check_timesheat" onclick="timesheat(this)" <?php if($employees_detail->check_timesheat == 'on'){ echo 'checked'; } ?>> Timesheets are approved by </p>
                                      <?if(empty($employees_detail->check_timesheat) || $employees_detail->check_timesheat != 'on') { ?>
                                       ...
                                       <?php }else{ ?>      
                                          <select class="form-control" id="" name="timesheet">
                                            <option value="">Select</option>         
                                            <?php foreach($groups as $row) {?>
                                  ...
                                  <div class="form-group">
                                       <p class="mt-2"><input class="mr-2" type="checkbox" id="timeoff_check" name="check_timeoff" onclick="timeoff(this)" <?php if($employees_detail->check_timeoff == 'on'){ echo 'checked'; } ?>> Time off is approved by </p>
                                      ...
                                      <?php }else{ ?>      
                                               <select class="form-control" id="" name="time_off">
                                               <option  value="">Select</option>     
                                             <?php foreach($groups as $row) {?>
                                  ...
                                  <div class="form-group">
                                      <p class="mt-2"><input class="mr-2" type="checkbox" id="expense_check" name="check_expense" onclick="expence(this)" <?php if($employees_detail->expense_check == 'on'){ echo 'checked'; } ?>> Expenses are approved by </p>
