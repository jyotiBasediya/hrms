...
<?php $system = $this->Hrms_model->read_setting_info(1);?>
    ...
    <div class="container-fluid">
      <div class="float-xs-right"> <a href="#" class="text-black">
        ...
        <?php 
			  ...
			  $login_date = $this->Hrms_model->set_date_format($gdate[0]);
			  echo $login_date.' '.date('h:i A', strtotime($last_login_date));?>
        <?php echo $this->lang->line('hrms_e_details_from');?> <?php echo $last_login_ip;?></span> </a> </div>
    </div>
  </div>
</div>
<div class="row">
      ...
      <div class="user-5">
        <div class="u-content">
          <div class="avatar box-96 mb-2">
            ...
            <img src="<?php echo base_url().'uploads/user_img/'.$profile_picture;?>" alt="" id="user_avatar" class="b-a-radius-circle user_profile_avatar">
            <?php } else {?>
            <?php if($gender=='Male') { ?>
          ...
          <button type="button" class="btn bg-facebook btn-circle" data-toggle="tooltip" data-placement="top" data-title="<?php echo $this->lang->line('hrms_e_details_fb');?>" data-original-title="" title="">
          <a href="<?php echo $facebook_link;?>" target="_blank" class="profile-social"> <i class="fa fa-facebook"></i></a>
          </button>
          <button type="button" class="btn bg-twitter btn-circle" data-toggle="tooltip" data-placement="top" data-title="<?php echo $this->lang->line('hrms_e_details_twit');?>" data-original-title="" title="">
          <a href="<?php echo $twitter_link;?>" target="_blank" class="profile-social"> <i class="fa fa-twitter"></i></a>
          </button>
          <button type="button" class="btn bg-googleplus btn-circle" data-toggle="tooltip" data-placement="top" data-title="<?php echo $this->lang->line('hrms_e_details_gplus');?>" data-original-title="" title="">
          <a href="<?php echo $google_plus_link;?>" target="_blank" class="profile-social"> <i class="fa fa-google-plus"></i></a>
          </button>
          <button type="button" class="btn bg-linkedin btn-circle" data-toggle="tooltip" data-placement="top" data-title="<?php echo $this->lang->line('hrms_e_details_lnkdin');?>" data-original-title="" title="">
          <a href="<?php echo $linkdedin_link;?>" target="_blank" class="profile-social"> <i class="fa fa-linkedin"></i></a>
          </button>
          <button type="button" class="btn bg-dropbox btn-circle" data-toggle="tooltip" data-placement="top" data-title="<?php echo $this->lang->line('hrms_e_details_blgr');?>" data-original-title="" title="">
  ...
  <div class="col-md-3">
    <div class="box bg-white">
      <ul class="nav nav-4 nav-tabs-link-cl">
        ...
        <li class="nav-item nav-item-link b-b-0" id="user_details_14"> <a class="nav-link nav-tabs-link" href="#change_password" data-profile="14" data-profile-block="change_password" data-toggle="tab" aria-expanded="true"> <i class="fa fa-key"></i> <?php echo $this->lang->line('hrms_e_details_cpassword');?> </a> </li>
      </ul>
    </div>
  </div>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="form-group">
              ...
              <textarea class="form-control" placeholder="<?php echo $this->lang->line('hrms_employee_address');?>" name="address" cols="30" rows="3" id="address"><?php echo $address;?></textarea>
            </div>
          </div>
        </div>
        <button type="submit" class="btn btn-primary save"><?php echo $this->lang->line('hrms_save');?></button>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class='form-group'> <span class="btn btn-primary btn-file"> Browse
              ...
              <?php if($profile_picture!='' && $profile_picture!='no file') {?>
              <img src="<?php echo site_url().'uploads/user_img/'.$profile_picture;?>" width="50px" style="margin-left:20px;" id="u_file">
              <?php } else {?>
              <?php if($gender=='Male') { ?>
    ...
    <div class="box box-block bg-white">
      <form id="contact_info" action="<?php echo site_url("employees/contact_info") ?>" name="contact_info" method="post">
        ...
        <div class="row">
          ...
          <div class="col-md-7">
            <div class="form-group">
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_e_details_dependent');?>" name="personal_email" type="text">
            </div>
          </div>
        </div>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              </span> <br /><small><?php echo $this->lang->line('hrms_e_details_d_type_file');?></small></div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-6">
