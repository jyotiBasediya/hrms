...
<div class="row row-sm">
  ...
  <?php
		...
		if($employee->is_active==1):
			$status = '<span class="tag tag-success">'.$this->lang->line('hrms_employees_active').'</span>';
		else:
			$status = '<span class="tag tag-danger">'.$this->lang->line('hrms_employees_inactive').'</span>';
		endif;
			?>
  <div class="col-md-4">
    <div class="box box-block bg-white">
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8">
          ...
          <abbr title="<?php echo $this->lang->line('hrms_phone');?>">P:</abbr> <?php echo $employee->contact_no;?><br>
          <abbr title="<?php echo $this->lang->line('dashboard_hrms_status');?>"><i class="fa fa-user"></i></abbr> <span class="s-text"><?php echo $status;?></span>
          </address>
        </div>
      </div>
    </div>
