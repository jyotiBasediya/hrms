         ...
         <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="select2 designationData" data-plugin="select_hrm" data-placeholder="Select Department..." name="transfer_department">
            <option value=""></option>
...
<!-- designation from -->
          <div class="col-md-6">
            <div class="form-group">
              ...
              <select class="select2 designationData" data-plugin="select_hrm" data-placeholder="Select Department..." name="transfer_department_from">
            <option value=""></option>
            <?php
           // print_r($all_designationFrom);
             foreach($all_designationFrom as $designationFrom) {?>
            <option value="<?php echo $designationFrom->designation_id?>" <?php if($designationFrom->designation_id==$designation_from):?> selected="selected"<?php endif;?>><?php echo $designationFrom->designation_name;?></option>
            <?php } ?>
          </select>
            </div>
          </div>
