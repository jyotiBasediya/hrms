...
<div class="add-form" style="display:none;">
  <div class="box box-block bg-white">
    <h2><strong><?php echo $this->lang->line('hrms_add_new');?></strong> <?php echo $this->lang->line('hrms_location');?>
                ...
                <div class="col-sm-6">
                 <!--  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_location_name');?>" name="name" type="text">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                   	 ...
                   	 <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_phone');?>" name="phone" type="text">
                      </div>
                      <div class="col-md-6">
                      	<label for="hrms_faxn"><?php echo $this->lang->line('hrms_faxn');?></label>
                    	<input class="form-control" placeholder="<?php echo $this->lang->line('hrms_faxn');?>" name="fax" type="text">
                      </div>
                    </div>
                  </div>
                </div>
...
<div class="box box-block bg-white">
  <h2><strong><?php echo $this->lang->line('hrms_list_all');?></strong> <?php echo $this->lang->line('hrms_locations');?>
    <div class="add-record-btn">
    ...
    <table class="table table-striped table-bordered dataTable" id="hrms_table" style="width:100%;">
      <thead>
        ...
        <tr>
          ...
          <th><?php echo $this->lang->line('hrms_location_name');?></th>
          <th><?php echo $this->lang->line('hrms_view_locationh');?></th>
