...
<form class="m-b-1" action="<?php echo site_url("location/update").'/'.$location_id; ?>" method="post" name="edit_location" id="edit_location">
    ...
    <div class="row">
      <div class="col-sm-6">
        <!-- <div class="form-group">
          <label for="company_name"><?php echo $this->lang->line('hrms_edit_company');?></label>
          <select class="form-control" name="company" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_edit_company');?>">
            <option value=""><?php echo $this->lang->line('hrms_edit_company');?></option>
        ...
        <div class="form-group">
          <label for="name"><?php echo $this->lang->line('hrms_location_name');?></label>
          <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_location_name');?>" name="name" type="text" value="<?php echo $location_name;?>">
        </div>
        <div class="form-group">
          <label for="email"><?php echo $this->lang->line('hrms_email');?></label>
          <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_email');?>" name="email" type="email" value="<?php echo $email;?>">
        </div>
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="phone"><?php echo $this->lang->line('hrms_phone');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_phone');?>" name="phone" type="number" value="<?php echo $phone;?>">
            </div>
            <div class="col-md-6">
              <label for="hrms_faxn"><?php echo $this->lang->line('hrms_faxn');?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('hrms_faxn');?>" name="fax" type="number" value="<?php echo $fax;?>">
            </div>
          </div>
        </div>
      </div>
      <div class="col-sm-6">
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="email"><?php echo $this->lang->line('hrms_view_locationh');?></label>
              <select class="form-control" name="location_head" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_view_locationh');?>">
            ...
            <div class="col-md-6">
              <label for="website"><?php echo $this->lang->line('hrms_view_locationmgr');?></label>
              <select class="form-control" name="location_manager" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_view_locationmgr');?>">
                <option value=""><?php echo $this->lang->line('hrms_select_one');?></option>
                <?php foreach($all_employees as $employee) {?>
  ...
  <div class="modal-footer">
    ...
    <button type="submit" class="btn btn-primary save"><?php echo $this->lang->line('hrms_update');?></button>
  </div>
</form>
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('hrms_view_location');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="row">
      <div class="col-sm-6">
        ...
        <div class="form-group">
          <div class="row">
            <div class="col-md-6">
              <label for="phone"><?php echo $this->lang->line('hrms_phone');?></label>
              <input class="form-control" readonly="readonly" style="border:0" placeholder="<?php echo $this->lang->line('hrms_phone');?>" name="phone" type="number" value="<?php echo $phone;?>">
            </div>
            <div class="col-md-6">
              <label for="hrms_faxn"><?php echo $this->lang->line('hrms_faxn');?></label>
              <input class="form-control" readonly="readonly" style="border:0" placeholder="<?php echo $this->lang->line('hrms_faxn');?>" name="fax" type="number" value="<?php echo $fax;?>">
            </div>
          </div>
        </div>
      </div>
