...
<div class="row m-b-1">
  <div class="col-md-4">
    <div class="box box-block bg-white">
      <h5><strong><?php echo $this->lang->line('hrms_project');?>: </strong> <?php echo $title;?></h5>
      <table class="table table-striped m-md-b-0">
        <tbody>
          <tr>
            <th scope="row"><?php echo $this->lang->line('dashboard_hrms_status');?></th>
            <td class="text-right"><?php echo $nstatus;?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('hrms_start_date');?></th>
            <td class="text-right"><?php echo $this->Hrms_model->set_date_format($start_date);?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('hrms_end_date');?></th>
            <td class="text-right"><?php echo $this->Hrms_model->set_date_format($end_date);?></td>
          </tr>
          <tr>
            <th scope="row"><?php echo $this->lang->line('hrms_createdp');?></th>
    ...
    <!-- assigned to-->
    <div class="box box-block bg-white">
      <h5><?php echo $this->lang->line('hrms_project_users');?></h5>
      <div class="row">
        <form action="<?php echo site_url("project/assign_project") ?>" method="post" name="assign_project" id="assign_project">
          <input type="hidden" name="project_id" id="project_id" value="<?php echo $project_id;?>">
          <div class="box-block">
            <div class="form-group">
              <label for="employees" class="control-label"><?php echo $this->lang->line('hrms_employee');?></label>
              <select multiple class="form-control" name="assigned_to[]" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('hrms_employee');?>">
