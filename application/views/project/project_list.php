                    ...
                    <table class="table table-hover mt-4 text-center" id="example">
                      <thead>
                        <tr>
                          ...
                          <th>
                            <?php if(in_array('9',$role_resources_ids) || in_array('67',$role_resources_ids)) { ?>
                            Action
                            <?php } ?>
                          </th>
                      ...
                      <tbody id="fbody">
                        ...
                        <tr>
                          ...
                          <td>
                            <?php 
                             $this->load->model('Client_model');
                                ...
                                $company_name = $client_detail->first_name.' '.$client_detail->last_name;
                                echo $company_name;
                            ?>
                          </td>
                          ...
                          <td>
                           ...
                           <a title="Edit" href="<?php echo site_url('project/editpost/'. $row['id']);?>"> <i class="fa fa-pencil" aria-hidden="true"></i></a>
                            <?php } if(in_array('67',$role_resources_ids)) { ?>
                             <a  title="Delete" href="<?php echo base_url().'Add_project/delete_project/'.$row['id'];?>" onclick="return deleteProject()">
...
<!--     <script src="assets/vendors/js/vendor.bundle.base.js"></script>
  ...
  function deleteProject(){
        var result = confirm("Are sure delete this project ?");
        if(result == true){
            return true;
        } 
        else{
