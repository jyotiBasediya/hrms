                ...
                <div class="page-header">
                   <div class="d-flex justify-content-between w-100">
                    ...
                    <div class="d-flex float-right"> 
                        <a href="<?php echo site_url();?>add_project_cost"> <button class="btn btn-secondary btn-fw"><i class="fa fa-plus-circle"aria-hidden="true"></i> Add Project </button></a>
                      <!--  -->
                    </div>  
                   </div>  
                </div> 
                    ...
                    <table class="table table-hover mt-4 text-center" id="example">
                      ...
                      <tbody id="fbody">
                        ...
                        <tr>
                          ...
                          <td><span><?php echo $row['project_name'];?></span></td>
                          <td ><?php echo $row['short_name'];?></td>
                          <td><span> </span></td>
                          <td> Project 1 </td>
                          <td>
                           <a href="<?php echo site_url('project/editpost/'. $row['id']);?>"> <i class="fa fa-pencil" aria-hidden="true"></i></a>
