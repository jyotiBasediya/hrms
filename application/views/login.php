       ...
       <!-- partial -->
        <div class="main-panel">
            <div class="content-wrapper">   
                 <div class="container">
                    <h1 class="form-heading my-5 text-center"><img width="320" src="assets/images/logo.png"></h1>
                     <div class="login-form">
                        <div class="main-div">
                              ...
                              <!-- <form class="mb-1" method="post" name="hrm-form" id="hrm-form" data-redirect="dashboard?module=dashboard" data-form-table="login" data-is-redirect="1"> -->
                                ...
                                <form action="<?php echo site_url();?>Login/login" method="post" data-parsley-validate>
                               ...
                               <!--  <div class="form-group">
                                  <input type="email" class="form-control"  name="iemail" id="iemail" placeholder="Email Address">
                                </div> -->
                                ...
                                <div class="forgot">
                                  <a class=" font-90" href="<?php echo site_url('forgot_password');?>">Forgot password?</a>
                                  <a class=" font-90" href="<?php echo site_url('Forgot_password/registration');?>">Signup</a>
                                </div>
