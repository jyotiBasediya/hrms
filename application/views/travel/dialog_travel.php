    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="Remark" name="remark" cols="10" rows="2" id="description2"><?php echo $comment;?></textarea>
        </div>
      </div>
        </div>
  </div>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea readonly="readonly" class="form-control" cols="30" rows="3"> <?php echo html_entity_decode($description);?></textarea>
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea readonly="readonly" class="form-control" cols="30" rows="3"> <?php echo $comment;?></textarea>
