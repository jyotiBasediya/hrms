          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->basic_salary);?></div>
            </div>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->overtime_rate);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="row m-b-1">
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Hrms_model->currency_sign($grade_template[0]->house_rent_allowance);?></div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Hrms_model->currency_sign($grade_template[0]->medical_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Hrms_model->currency_sign($grade_template[0]->travelling_allowance);?> </div>
              </div>
              <?php endif;?>
              ...
              <div class="col-md-12">
                <div class="f">
                  ...
                  <?php echo $this->Hrms_model->currency_sign($grade_template[0]->dearness_allowance);?> </div>
              </div>
              <?php endif;?>
            </div>
          </blockquote>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->provident_fund);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->tax_deduction);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->security_deposit);?> </div>
            </div>
            <?php endif;?>
          </div>
        </div>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->gross_salary);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->total_allowance);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->total_deduction);?> </div>
            </div>
            <?php endif;?>
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($grade_template[0]->net_salary);?> </div>
            </div>
            <?php endif;?>
          </div>
        </div>
          ...
          <div class="row m-b-1">
            ...
            <div class="col-md-12">
              <div class="f">
                ...
                <?php echo $this->Hrms_model->currency_sign($hourly_template[0]->hourly_rate);?> </div>
            </div>
            <?php if(isset($_GET['mode']) && $_GET['mode'] == 'not_paid'):?>
            <div class="col-md-12">
              <div class="f">
