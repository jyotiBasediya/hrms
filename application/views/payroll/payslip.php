          ...
          <table class="table table-no-border table-condensed">
            <tbody>
              ...
              <tr>
                ...
                <td><strong class="help-split">Joining Date: </strong><?php echo $this->Hrms_model->set_date_format($date_of_joining);?></td>
        ...
        <div class="panel-body p-none">
          <table class="table table-condensed">
            <tbody>
              ...
              <tr>
                <td><strong>Hourly Rate:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($hourly_rate);?></span></td>
              </tr>
              <?php endif;?>
              ...
              <tr>
                <td><strong>Overtime Salary:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($overtime_rate);?> (Hourly)</span></td>
              </tr>
              <?php endif;?>
            </tbody>
          </table>
        ...
        <div class="panel-body p-none">
          ...
          <table class="table table-condensed">
            <tbody>
              <?php if($overtime_rate!=0 || $overtime_rate!=''):?>
              <tr>
                <td><strong>Gross Salary:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($gross_salary);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($total_allowances!=0 || $total_allowances!=''):?>
              <tr>
                <td><strong>Total Allowance:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($total_allowances);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($total_deductions!=0 || $total_deductions!=''):?>
              <tr>
                <td><strong>Total Deduction:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($total_deductions);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($net_salary!=0 || $net_salary!=''):?>
              <tr>
                <td><strong>Net Salary:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($net_salary);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($net_salary!=0 || $net_salary!=''):?>
              <tr>
                <td><strong>Paid Amount:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($net_salary);?></span></td>
              </tr>
              <?php endif;?>
          ...
          <table class="table table-condensed">
            <tbody>
              ...
              <tr>
                <td><strong>Gross Salary:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($payment_amount);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($total_hours_work!=0 || $total_hours_work!=''):?>
              <tr>
                <td><strong>Net Salary:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($payment_amount);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($total_hours_work!=0 || $total_hours_work!=''):?>
              <tr>
                <td><strong>Paid Amount:</strong> <span class="pull-right"><?php echo $this->Hrms_model->currency_sign($payment_amount);?></span></td>
              </tr>
              <?php endif;?>
              <?php if($payment_method):?>
              <tr>
