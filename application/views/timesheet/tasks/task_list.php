                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input class="form-control date" placeholder="End Date" readonly name="expected_end_date" type="text" value="">
                      </div>
                    </div>
                  </div>
                  <div class="row" style="display: none;">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" placeholder="Estimated Hour" name="task_hour" type="text" value="0">
                      </div>
                    </div>
                  </div>
                  <div class="row">
