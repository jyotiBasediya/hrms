    ...
    <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input class="form-control edate" placeholder="End Date" readonly="true" name="expected_end_date" type="text" value="<?php echo $expected_end_date;?>">
            </div>
          </div>
        </div>
        <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group">
          ...
          <textarea class="form-control textarea" placeholder="Description" name="description" cols="30" rows="14" id="description2"><?php echo $description;?></textarea>
        </div>
      </div>
    </div>
  </div>
