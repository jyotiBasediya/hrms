...
<?php $u_created = $this->Hrms_model->read_user_info($session['user_id']);?>
      ...
      <table class="table table-striped m-md-b-0">
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><?php echo $this->Hrms_model->set_date_format($start_date);?></td>
          </tr>
          <tr>
            <th scope="row">Expected End Date</th>
            <td class="text-right"><?php echo $this->Hrms_model->set_date_format($expected_end_date);?></td>
          </tr>
          <tr>
            <th scope="row">Completed Date</th>
            <td class="text-right"><?php echo ($end_date)?$this->Hrms_model->set_date_format($end_date):'-';?></td>
          </tr>
          <!-- <tr>
    ...
    <div class="box box-block bg-white">
      <div class="wizard" role="tabpanel">
        <ul class="nav nav-tabs m-b-1" role="tablist">
          ...
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#comment" role="tab"><i class="fa fa-comment"></i> Performance</a> </li>
          <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#queries" role="tab"><i class="fa fa-pencil"></i> Queries</a> </li>
        ...
        <div class="tab-content m-b-1">
          <div role="tabpanel" class="tab-pane animated fadeInRight active fade in" id="detail" style="overflow:auto;">
            ...
            <div class="col-md-6">
              ...
              <div class="items-list" id="all_employees_list">
                ...
                <?php $e_name = $this->Hrms_model->read_user_info($assign_id);?>
                ...
                <?php
						if($e_name[0]->profile_picture!='' && $e_name[0]->profile_picture!='no file') {
							$u_file = base_url().'uploads/user_img/'.$e_name[0]->profile_picture;
						} else {
          ...
          <div role="tabpanel" class="tab-pane animated fadeInRight fade" id="comment">
            <form action="<?php echo site_url("timesheet/set_comment") ?>" method="post" name="set_comment" id="set_comment">
              ...
              <div class="box-block">
                <div class="form-group">
                  <textarea name="hrms_comment" id="hrms_comment" class="form-control" rows="4" placeholder="Performance"></textarea>
                </div>
                <button type="submit" class="btn btn-primary save">Save</button>
              </div>
            </form>
            ...
            <div class="table-responsive">
              <table class="table table-hover mb-md-0" id="hrms_comment_table" style="width:100%;">
                <thead>
                  <tr>
                    <th>Performance</th>
                  </tr>
          ...
          <div role="tabpanel" class="tab-pane animated fadeInRight fade" id="attachment">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-striped table-bordered table-ajax-load" id="hrms_attachment_table" style="width:100%;">
                <thead>
                  <tr>
                    <th>Option</th>
                    <th>File</th>
          ...
          <div role="tabpanel" class="tab-pane animated fadeInRight fade" id="queries">
            <div class="table-responsive">
              <table class="table table-hover table-striped table-bordered table-ajax-load" id="hrms_query_table" style="width:100%;">
                <thead>
                  <tr>
                    <th>Employee</th>
                    <th>Query</th>
