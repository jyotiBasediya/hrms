              ...
              <div class="row">
                <div class="col-md-5">
                  <div class="form-group">
                    <input class="form-control attendance_date" placeholder="Select Date" readonly id="start_date" name="start_date" type="text" value="<?php echo date('Y-m-01');?>">
                  </div>
                </div>
                <div class="col-md-5">
                  <div class="form-group">
                    <input class="form-control attendance_date" placeholder="Select Date" readonly id="end_date" name="end_date" type="text" value="<?php echo date('Y-m-t');?>">
                  </div>
                </div>
              </div>
              <div class="row">
...
<script type="text/javascript">
  ...
  $(document).on('click', '.btn-view', function(){
    $.ajax({
      ...
      type: 'post',
      data: {user_id: $(this).attr('data-user_id'), date: $(this).attr('data-date')},
