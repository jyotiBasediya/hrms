    ...
    <table class="table table-striped m-md-b-0">
      <tbody>
        ...
        <tr>
          ...
          <td class="text-right"><?php echo $this->Hrms_model->currency_sign($training_cost);?></td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td class="text-right"><?php echo $this->Hrms_model->set_date_format($finish_date);?></td>
        </tr>
        <tr>
