...
<div class="modal-header">
  ...
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('hrms_edit_policy');?></h4>
</div>
...
<script type="text/javascript">
 $(document).ready(function(){
    ...
    $('#description2')['summernote']({height:137,minHeight:null,maxHeight:null,focus:false});
...
<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('hrms_view_policy');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="form-group">
