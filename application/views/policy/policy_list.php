...
?>
  <div class="col-md-4">
    <div class="box box-block bg-white">
      <h2><strong><?php echo $this->lang->line('hrms_add_new');?></strong> <?php echo $this->lang->line('hrms_policy');?></h2>
      <form class="m-b-1" action="<?php echo site_url("policy/add_policy") ?>" method="post" name="add_policy" id="xin-form">
        ...
        <div class="form-group">
          ...
          <textarea class="form-control" placeholder="<?php echo $this->lang->line('hrms_description');?>" name="description" id="description" rows="5"></textarea>
        </div>
  ...
  <div class="<?=$colVal?>">
    <div class="box box-block bg-white">
      <h2><strong><?php echo $this->lang->line('hrms_list_all');?></strong> <?php echo $this->lang->line('hrms_policies');?></h2>
