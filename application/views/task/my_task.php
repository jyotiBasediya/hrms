                                ...
                                <?php 
                                    ...
                                    <tr>
                                        <td class="prj_nam_cls">
                                           ...
                                           <select class="form-control task_id" placeholder="Client Name" name="task_id[]" id="task_id_<?php echo $i;?>" onchange="getTaskDetail(this.value,'<?php echo $i;?>');">
                                        ...
                                        <?php
                                            ...
                                            for ($y; $y<7 ; $y++,$yts += 86400) {
                                                ...
                                                <td>
                                                   ...
                                                   <input type="hidden" name="taksId[]" value="" class="taskId_<?php echo $i;?>" >
...
<script type="text/javascript">
  ...
  function getTaskDetail(task_id,id)
  {
     $('.taskId_'+id).val(task_id);
  }
