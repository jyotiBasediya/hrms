...
class performance_indicator_model extends CI_Model {
	...
	{
	  return $this->db->get("hrms_performance_indicator");
	}
	 ...
	 public function read_performance_indicator_information($id) {
		...
		$this->db->select('*');
		$this->db->from('hrms_performance_indicator');
	...
	public function add($data){
		$this->db->insert('hrms_performance_indicator', $data);
	...
	public function delete_record($id){
		...
		$this->db->delete('hrms_performance_indicator');
	...
	public function update_record($data, $id){
		$this->db->where('performance_indicator_id', $id);
		if( $this->db->update('hrms_performance_indicator',$data)) {
			return true;
		} else {
			return false;
		}		
