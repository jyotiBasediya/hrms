...
class employee_exit_model extends CI_Model {
	...
	{
	  return $this->db->get("hrms_employee_exit");
	}
	 ...
	 public function read_exit_information($id) {
		...
		$this->db->select('*');
		$this->db->from('hrms_employee_exit');
	...
	public function all_exit_types() {
	  $query = $this->db->query("SELECT * from hrms_employee_exit_type");
  	  return $query->result();
	}
	...
	public function add($data){
		$this->db->insert('hrms_employee_exit', $data);
	...
	public function delete_record($id){
		...
		$this->db->delete('hrms_employee_exit');
	...
	public function update_record($data, $id){
		$this->db->where('exit_id', $id);
		if( $this->db->update('hrms_employee_exit',$data)) {
			return true;
		} else {
			return false;
		}		
