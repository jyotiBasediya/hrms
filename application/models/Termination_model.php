...
class termination_model extends CI_Model {
	...
	{
	  return $this->db->get("hrms_employee_terminations");
	}
	 ...
	 public function read_termination_information($id) {
		...
		$this->db->select('*');
		$this->db->from('hrms_employee_terminations');
	...
	public function all_termination_types() {
	  $query = $this->db->query("SELECT * from hrms_termination_type");
  	  return $query->result();
	}
	...
	public function add($data){
		$this->db->insert('hrms_employee_terminations', $data);
	...
	public function delete_record($id){
		...
		$this->db->delete('hrms_employee_terminations');
	...
	public function update_record($data, $id){
		$this->db->where('termination_id', $id);
		if( $this->db->update('hrms_employee_terminations',$data)) {
			return true;
		} else {
			return false;
		}		
