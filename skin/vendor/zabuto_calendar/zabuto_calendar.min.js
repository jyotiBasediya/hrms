            ...
            if (events !== false) {
                $(events).each(function (index, value) {
                    ...
                    if (typeof(value.badge) !== 'undefined' && value.badge !== false) {
                        ...
                        $dayElement.html('<span class="badge badge-event' + badgeClass + '">' + dayLabel + '</span><div class="color-box"><span class="show-color-1"></span><span class="show-color-2"></span><span class="show-color-3"></span></div>');
                    }
